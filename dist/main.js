...
let AddBookComponent = class AddBookComponent {
    ...
    saveBook(formValues) {
        ...
        this.dataService.addBook(newBook)
            .subscribe((data) => console.log(data), (err) => console.log(err), () => console.log('add book complete'));
    }
};
...
let EditBookComponent = class EditBookComponent {
    ...
    saveChanges() {
        this.dataService.updateBook(this.selectedBook)
            .subscribe((data) => console.log(`${this.selectedBook.title} updated successfully`), (err) => console.log(err), () => console.log('update book complete'));
    }
};
...
/* harmony import */ var _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/bookTrackerError */ "+5Uy");
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        ...
        if (resolvedData instanceof _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_6__["BookTrackerError"])
    ...
    deleteBook(bookID) {
        ...
        }, (err) => console.log(err), () => console.log('delete book complete'));
    }
...
let CacheInterceptor = class CacheInterceptor {
    ...
    intercept(req, next) {
        ...
        if (cachedResponse) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(cachedResponse); //same as next.handle without the 'next' operator. Just shorthand if there is one unmutable response.
        }
